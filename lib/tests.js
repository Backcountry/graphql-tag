...
describe('gql', function () {
    ...
    it('tracks fragment dependencies across fragments loaded via the webpack loader', function () {
        ...
        var require = function (path) {
            assert.equal(path, './fragment_definition.graphql');
            return gql(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n        fragment F222 on F {\n          f1\n          f2\n        }"], ["\n        fragment F222 on F {\n          f1\n          f2\n        }"])));
        };
        Function("module,require", jsSource)(module, require);
        assert.exists(module.exports.Q1);
        assert.exists(module.exports.Q2);
    ...
    describe('fragment warnings', function () {
        ...
        it('warns if you use the same fragment name for different fragments', function () {
            var frag1 = gql(templateObject_10 || (templateObject_10 = __makeTemplateObject(["fragment TestSame on Bar { fieldOne }"], ["fragment TestSame on Bar { fieldOne }"])));
            var frag2 = gql(templateObject_11 || (templateObject_11 = __makeTemplateObject(["fragment TestSame on Bar { fieldTwo }"], ["fragment TestSame on Bar { fieldTwo }"])));
            assert.isFalse(frag1 === frag2);
            assert.equal(warnings.length, 1);
        });
        it('does not warn if you use the same embedded fragment in two different queries', function () {
            var frag1 = gql(templateObject_12 || (templateObject_12 = __makeTemplateObject(["fragment TestEmbedded on Bar { field }"], ["fragment TestEmbedded on Bar { field }"])));
            var query1 = gql(templateObject_13 || (templateObject_13 = __makeTemplateObject(["{ bar { fieldOne ...TestEmbedded } } ", ""], ["{ bar { fieldOne ...TestEmbedded } } ", ""])), frag1);
            var query2 = gql(templateObject_14 || (templateObject_14 = __makeTemplateObject(["{ bar { fieldTwo ...TestEmbedded } } ", ""], ["{ bar { fieldTwo ...TestEmbedded } } ", ""])), frag1);
        ...
        it('does not warn if you use the same fragment name for embedded and non-embedded fragments', function () {
            var frag1 = gql(templateObject_15 || (templateObject_15 = __makeTemplateObject(["fragment TestEmbeddedTwo on Bar { field }"], ["fragment TestEmbeddedTwo on Bar { field }"])));
            gql(templateObject_16 || (templateObject_16 = __makeTemplateObject(["{ bar { ...TestEmbedded } } ", ""], ["{ bar { ...TestEmbedded } } ", ""])), frag1);
            gql(templateObject_17 || (templateObject_17 = __makeTemplateObject(["{ bar { ...TestEmbedded } } fragment TestEmbeddedTwo on Bar { field }"], ["{ bar { ...TestEmbedded } } fragment TestEmbeddedTwo on Bar { field }"])));
            assert.equal(warnings.length, 0);
        });
    });
    describe('unique fragments', function () {
        ...
        it('strips duplicate fragments from the document', function () {
            var frag1 = gql(templateObject_18 || (templateObject_18 = __makeTemplateObject(["fragment TestDuplicate on Bar { field }"], ["fragment TestDuplicate on Bar { field }"])));
            var query1 = gql(templateObject_19 || (templateObject_19 = __makeTemplateObject(["{ bar { fieldOne ...TestDuplicate } } ", " ", ""], ["{ bar { fieldOne ...TestDuplicate } } ", " ", ""])), frag1, frag1);
            var query2 = gql(templateObject_20 || (templateObject_20 = __makeTemplateObject(["{ bar { fieldOne ...TestDuplicate } } ", ""], ["{ bar { fieldOne ...TestDuplicate } } ", ""])), frag1);
